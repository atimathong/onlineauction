...
<head>
  ...
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.2/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-Zenh87qX5JnK2Jl0vWa8Ck2rdkQ2Bzep5IDxbcnCeuOxjzrPF/et3URy9Bv1WTRi" crossorigin="anonymous">
    ...
    <script defer src="./img_upload.js"></script>
    <script>
    </script>
</head>
...
<div style="max-width: 800px; margin: 10px auto">
  ...
  <div class="card">
    ...
    <small id="formHelp" class="form-text text-muted"><span class="text-danger">* Fields are Required.</span>
      ...
      <form action="img_upload.php" method="POST" id= "img-upload" onsubmit="return uploadValidation()" enctype="multipart/form-data">
