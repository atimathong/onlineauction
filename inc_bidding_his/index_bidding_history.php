    ...
    <div class="container-fuild">
        ...
        <table class="table">
            ...
            <tbody>
                ...
                $sql = "SELECT * FROM item JOIN category ON item.category_ID = category.category_ID JOIN users ON item.user_ID = users.user_id WHERE users.user_type IN ('buyer', 'both') AND users.email = '$email'";  # select data from sql table
